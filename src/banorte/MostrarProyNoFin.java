...
public class MostrarProyNoFin extends javax.swing.JFrame {

    /**
     * Creates new form MostrarInfoGer
     */
    public MostrarProyNoFin() {
        this.setTitle("Proyectos no finalizados del Gerente");
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
                    textArea1.setText("");
            textArea1.replaceText("", WIDTH, WIDTH);
            ...
            while((contador<numRegistros)){
                ...
                if((pruebaId==identificador)&&!terminado){
                    ...
                    for(int i=0; i<30; i++)
                        ...
                        linea = "Proyecto del usuario: " + Integer.toString(pruebaId).substring(1,9) + "\nID proyecto: " + IDproyecto + "\nNombre proyecto: " + nombreP + "\nProyecto terminado" + "\nDirección general: " + direcGral
            ...
            if(!encontrado)
                textArea1.setText("ID sin proyectos no finalizados o mal introducido. \nIntente de nuevo.");
        } catch (FileNotFoundException ex) {
            Logger.getLogger(MostrarProyNoFin.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MostrarProyNoFin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MostrarProyNoFin().setVisible(true);
            }
        });
    }
